...
public class CtorAnalyzer {
     ...
     * Constructor.
     *
     * @param ctor The constructor to analyze, not null.
     */
	 ...
	 * 
	 * @return the result of the constructor call, or null
     ...
     * object in the constructor.
     *  
     * @param callerStack the content of the local variable table 
     *        of the constructor.
     *
     * @return whether the reference of the checked object escapes.
     */
