 ...
 * 
 * <ul>
 * <li> The class which should be analyzed as immutable by the ClassAnalyzer are marked
 * with the annotation {@link Immutable}. Classes which are not marked by this annotation 
 * are not immutable.
 * 
 * <li>The test logic and binding is implemented in a project specific JUnit runner 
 * {@link ImmutableClassTestRunner}.
 * 
 * <li> The definition of a immutable class see JavaDoc of annotation {@link Immutable}.
 * </ul>
 * 
 * @see Immutable
