...
public class ThreeValueBooleanTest {
	...
	public void testAndThreeValueBoolean() {
		assertEquals(ThreeValueBoolean.no.and(ThreeValueBoolean.no),
				ThreeValueBoolean.no);
		assertEquals(ThreeValueBoolean.no.and(ThreeValueBoolean.unknown),
				ThreeValueBoolean.no);
		assertEquals(ThreeValueBoolean.no.and(ThreeValueBoolean.yes),
				ThreeValueBoolean.no);

		assertEquals(ThreeValueBoolean.unknown.and(ThreeValueBoolean.no),
				ThreeValueBoolean.no);
		assertEquals(ThreeValueBoolean.unknown.and(ThreeValueBoolean.unknown),
				ThreeValueBoolean.unknown);
		assertEquals(ThreeValueBoolean.unknown.and(ThreeValueBoolean.yes),
				ThreeValueBoolean.unknown);

		assertEquals(ThreeValueBoolean.yes.and(ThreeValueBoolean.no),
				ThreeValueBoolean.no);
		assertEquals(ThreeValueBoolean.yes.and(ThreeValueBoolean.unknown),
				ThreeValueBoolean.unknown);
		assertEquals(ThreeValueBoolean.yes.and(ThreeValueBoolean.yes),
	...
	public void testAndBoolean() {
		...
		assertEquals(ThreeValueBoolean.unknown.and(true),
				ThreeValueBoolean.unknown);
	...
	public void testOrThreeValueBoolean() {
		assertEquals(ThreeValueBoolean.no.or(ThreeValueBoolean.no),
				ThreeValueBoolean.no);
		assertEquals(ThreeValueBoolean.no.or(ThreeValueBoolean.unknown),
				ThreeValueBoolean.unknown);
		assertEquals(ThreeValueBoolean.no.or(ThreeValueBoolean.yes),
				ThreeValueBoolean.yes);

		assertEquals(ThreeValueBoolean.unknown.or(ThreeValueBoolean.no),
				ThreeValueBoolean.unknown);
		assertEquals(ThreeValueBoolean.unknown.or(ThreeValueBoolean.unknown),
				ThreeValueBoolean.unknown);
		assertEquals(ThreeValueBoolean.unknown.or(ThreeValueBoolean.yes),
				ThreeValueBoolean.yes);

		assertEquals(ThreeValueBoolean.yes.or(ThreeValueBoolean.no),
				ThreeValueBoolean.yes);
		assertEquals(ThreeValueBoolean.yes.or(ThreeValueBoolean.unknown),
				ThreeValueBoolean.yes);
		assertEquals(ThreeValueBoolean.yes.or(ThreeValueBoolean.yes),
				ThreeValueBoolean.yes);
	}
	...
	public void testOrBoolean() {
		...
		assertEquals(ThreeValueBoolean.unknown.or(false),
				ThreeValueBoolean.unknown);
